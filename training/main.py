...
def parse_opt(known=False):
    ...
    parser.add_argument('--model', type=str, default="configs/base_mlp.yaml", help='initial weights path')
    ...
    parser.add_argument('--project', default="nba-match-prediction", help='save to project/name')
