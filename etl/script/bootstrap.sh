...
wget https://repo.anaconda.com/miniconda/Miniconda3-latest-Linux-x86_64.sh -O ${MLFLOW_USER_HOME}/miniconda3/miniconda.sh > /dev/null 2>&1
bash ${MLFLOW_USER_HOME}/miniconda3/miniconda.sh -b -u -p ${MLFLOW_USER_HOME}/miniconda3  > /dev/null 2>&1
