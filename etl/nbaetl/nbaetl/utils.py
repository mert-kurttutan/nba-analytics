...
def gamelog_name(year, season_type):
    return f"gamelog_{year}_{season_type}.csv"


def daystat_name(stat_type, year, season_type, cur_date, lag_len):
    return (
        f'{stat_type}_{year}_{season_type}_{cur_date}_lagged{lag_len}.csv'
    )


def daystat_name_transformed(stat_type, year, season_type):
    return (
        f'{stat_type}_{year}_{season_type}.csv'
    )


def daystat_name_filled(stat_type, year, season_type):
    return (
        f'{stat_type}_{year}_{season_type}_filled.csv'
    )


def training_name(year, season_type):
    return f'training_{year}_{season_type}.csv'
